...
export type ContentfulBlockCostItemFieldsEnum = 
  ...
  | 'childContentfulBlockCostItemTextTextNode___childMdx___frontmatter___layout'
  | 'childContentfulBlockCostItemTextTextNode___childMdx___frontmatter___template'
...
export type BlockCostItemFragment = (
  Pick<ContentfulBlockCostItem, 'id' | 'title' | 'variant' | 'priceText'>
  & { text?: Maybe<(
...
export type BlockGoogleMapsFragment = Pick<ContentfulBlockGoogleMap, 'id' | 'name' | 'variant' | 'placeId' | 'lat' | 'long' | 'zoom'>;

export type BlockFragment = (
  Pick<ContentfulBlock, 'id' | 'name' | 'variant'>
  & { text?: Maybe<(
