...
exports.Providers = (props) => {
    return (react_2.default.createElement(react_treat_1.TreatProvider, { theme: theme_treat_1.light },
        react_2.default.createElement(core_react_ui_1.ViewportProvider, { context: core_react_ui_1.viewportContext },
            react_2.default.createElement(core_react_ui_1.TreatThemeProvider, { theme: { theme: theme_treat_1.theme, cssTheme: theme_treat_1.cssTheme } },
