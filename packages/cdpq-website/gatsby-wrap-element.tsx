...
import { LayoutDesignSystem, LayoutDocs } from '@newrade/core-gatsby-ui/src';
import { PageProps, WrapPageElementBrowserArgs } from 'gatsby';
import React from 'react';
import MobileLogo from './src/images/LogoIcon.svg';
import Logo from './src/images/LogoStandard.svg';
...
export const WrapElement: React.FC<WrapPageElementBrowserArgs> = ({ element, props }) => {
  ...
  switch (pageProps.pageContext.layout) {
    case 'docs': {
      return <LayoutDocs {...pageProps}>{element}</LayoutDocs>;
    }
    case 'designSystem': {
      return (
