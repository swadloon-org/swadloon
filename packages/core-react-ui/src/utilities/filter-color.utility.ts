...
/**
 * Color transformation utility class to calculate a filter to change a color from one
 * to another.
 */
...
export class ColorFilterSolver {
  targetHSL: { h: number; s: number; l: number };
  reusedColor: ColorFilter;

  constructor(public target: ColorFilter, public baseColor?: ColorFilter) {
