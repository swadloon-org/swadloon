...
export function createDefaultColorIntents(colors: Colors): ColorIntents {
  return {
    ...
    successBackground: colors.utilityGreen['500'],
    warningText: colors.utilityGreen['500'],
    warningAction: colors.utilityGreen['500'],
    warningBackground: colors.utilityGreen['500'],
    dangerText: colors.utilityGreen['500'],
    dangerAction: colors.utilityGreen['500'],
    dangerBackground: colors.utilityGreen['500'],
