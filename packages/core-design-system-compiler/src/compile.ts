...
/**
 * High level function that parse Figma tokens and outputs design system compatible objects
 * (e.g. figma-colors.ts => colors.ts)
 */
export async function compile(options: ExtractOptions) {
  debug.enable('nr:core-design-system-compiler:*');
