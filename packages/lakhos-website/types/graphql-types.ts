...
export type GraphCms_BlogAuthorProfilePictureArgs = {
  locales?: Maybe<Array<GraphCms_Locale>>;
};
...
export type GraphCms_BlogPostMainImageArgs = {
  locales?: Maybe<Array<GraphCms_Locale>>;
};
...
export type GraphCms_EmployeeProfilePictureArgs = {
  locales?: Maybe<Array<GraphCms_Locale>>;
};
...
export type GraphCms_PodcastImageArgs = {
  locales?: Maybe<Array<GraphCms_Locale>>;
};


export type GraphCms_PodcastPodcastStatusArgs = {
  locales?: Maybe<Array<GraphCms_Locale>>;
};
...
export type GraphCms_PodcastStatusNextPodcastArgs = {
  locales?: Maybe<Array<GraphCms_Locale>>;
};
