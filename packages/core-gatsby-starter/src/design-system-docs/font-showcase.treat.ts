...
export const styles = {
  ...
  lettersSans: style(({ theme, cssTheme }: Theme) => ({
    ...capsize({ fontMetrics: theme.typography.fonts.sans[0].fontMetrics, capHeight: 100, lineGap: 10 }),
  ...
  lettersSansAlternate: style(({ theme, cssTheme }: Theme) => ({
    ...capsize({ fontMetrics: theme.typography.fonts.sansAlternate[0].fontMetrics, capHeight: 100, lineGap: 10 }),
  ...
  lettersSansSerif: style(({ theme, cssTheme }: Theme) => ({
    ...capsize({ fontMetrics: theme.typography.fonts.serif[0].fontMetrics, capHeight: 100, lineGap: 10 }),
  ...
  lettersSansMono: style(({ theme, cssTheme }: Theme) => ({
    ...capsize({ fontMetrics: theme.typography.fonts.monospace[0].fontMetrics, capHeight: 100, lineGap: 10 }),
