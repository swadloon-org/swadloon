    ...
    <Layout>
      <Stack id={'HTML Elements'} gap={'55px'} padding={'55px'}>
        ...
        <Stack id={'Inline text semantics'} gap={'21px'} padding={'20px'}>
          ...
          <h3>b</h3>
          <p>
            The two most popular science courses offered by the school are <b className="term">chemistry</b> (the study
            of chemicals and the composition of substances) and <b className="term">physics</b> (the study of the nature
          ...
          <p>
            The term <i>bandwidth</i> describes the measure of how much information can pass through a data connection
          ...
          <h3>strong</h3>
          <p>
            ... the most important rule, the rule you can never forget, no matter how much he cries, no matter how much
        ...
        <Stack id={'Forms'} gap={'21px'} padding={'20px'}>
          ...
          <Stack id={'content-form'} gap={'21px'} padding={'20px'}>
            ...
            <textarea
              defaultValue="was a dark and stormy night..."
              id="story"
              name="story"
              rows={5}
              cols={33}
